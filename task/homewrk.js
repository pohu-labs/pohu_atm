...
export default function HomeWork(props) {
    const name = "admin";
    const email = "admin@srishtiworldschools.in";
    ...
    return (
        <View style={[styles.container]}>
            <SafeAreaView>
                <View>
                    {/* <Text style={{ marginBottom: 30 }}>Enter your questions(Share your thoughts i.e why,when,what)</Text> */}
                    <Input
                ...
                <View style={{ height: 120, marginBottom: 30 ,alignItems:"center"}} >
                    <Text style={{ marginBottom: 10 }}>Please upload the Documents taught in the said class</Text>
                    <TouchableOpacity
                        style={{width:350,borderRadius: 1,height: 50,alignItems: "center",justifyContent: "center",marginTop: 40,backgroundColor: "#1976D2"}}
                        activeOpacity={0.5}
                        onPress={selectFile}>
